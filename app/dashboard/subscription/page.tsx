    ...
    <div className="max-w-4xl mx-auto py-12 px-6">
      ...
      >
        ...
        <p className="text-lg text-gray-600">
          Everything is free! No billing, no limits.
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <Check className="w-5 h-5 text-green-500 flex-shrink-0" />
              <p className="text-gray-700">
                <strong>All</strong> Themes & Templates
              </p>
            </div>
            <div className="flex items-center gap-3">
              <Check className="w-5 h-5 text-green-500 flex-shrink-0" />
              <p className="text-gray-700">
                <strong>Full</strong> Order Management
              </p>
            </div>
            <div className="flex items-center gap-3">
              <Check className="w-5 h-5 text-green-500 flex-shrink-0" />
        ...
        >
          ...
          <p className="mb-6 opacity-90">
            We're working on exciting Pro features including AI-powered tools, advanced analytics, and more! Stay tuned.
          </p>
          <button
            disabled
          ...
          <p className="text-xs text-white/70 mt-3 text-center">
            For now, enjoy all features completely free!
          </p>
        </motion.div>
      </div>
    </div>
