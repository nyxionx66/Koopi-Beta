  ...
  const features = [
    {
      ...
      description: "Get your store up and running in minutes, not days. No technical skills required.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Your store looks perfect on every device. Responsive design out of the box.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Accept payments safely with built-in payment processing and fraud protection.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Track sales, visitors, and performance with real-time analytics and insights.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Custom Themes",
      description: "Choose from beautiful templates or customize your store to match your brand.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "24/7 Support",
      description: "Get help whenever you need it. Our team is here to support your success.",
    },
  ];
